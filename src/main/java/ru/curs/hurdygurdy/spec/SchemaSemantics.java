...
public final class SchemaSemantics {
     ...
     */
    public static String effectiveType(Schema<?> schema) {
        if (schema == null) {
            return null;
        }
     ...
     */
    public static boolean isNullableSchema(Schema<?> schema) {
        if (schema == null) {
            return false;
        }
     ...
     */
    public static boolean describesObject(Schema<?> schema) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public static List<Schema> polymorphicMembers(Schema<?> schema) {
     ...
     */
    public static boolean isPolymorphicInterface(Schema<?> schema) {
    ...
    public static List<String> getExtendsList(Schema<?> schema) {
     ...
     */
    public static String getEnumName(Schema<?> schema, String typeNameFallback) {
     ...
     */
    public static Map<String, String> getSubclassMapping(Schema<?> schema) {
     ...
     */
    public static boolean nullableOf(OpenAPI openAPI, String className, Boolean defaultValue) {
     ...
     */
    public static String defaultOf(OpenAPI openAPI, String className) {
     ...
     */
    public static boolean isEnumComponent(OpenAPI openAPI, String className) {
        return Optional.ofNullable(componentSchema(openAPI, className))
                .map(Schema::getEnum)
                .map(l -> !l.isEmpty())
                .orElse(false);
     ...
     */
    public static void checkReferenceIsGeneratable(String ref) {
     ...
     */
    public static String extractGroup(String ref, Pattern pattern) {
