 ...
 */
public final class JavaQuarkusBinding implements JavaFrameworkBinding {

    /** The resource path annotation, also put on the interface by the extractor. */
    public static final ClassName JAXRS_PATH = ClassName.get("jakarta.ws.rs", "Path");
